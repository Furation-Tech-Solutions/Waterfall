    ...
    static toEntity(
        ...
        if (existingJob != null) {
            ...
            return {
              ...
              address:
                jobData.address !== undefined
                  ? jobData.address
                  : existingJob.address,
              date:
                jobData.date !== undefined ? jobData.date : existingJob.date,
              numberOfApplicants:
