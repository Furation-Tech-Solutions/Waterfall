...
export class DeleteAccount implements DeleteAccountUsecase {
  ...
  async execute(
    ...
    return await this.paymentGatewayRepository.deleteAccount(loginId); // Call the 'createPaymentGateway' method of the PaymentGatewayRepository and return the result
  }
}
