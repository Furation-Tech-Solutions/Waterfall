...
export class UpdateAccount implements UpdateAccountUsecase {
  ...
  async execute(
    ...
    return await this.paymentGatewayRepository.updateAccount(loginId,data); // Call the 'createPaymentGateway' method of the PaymentGatewayRepository and return the result
  }
}
