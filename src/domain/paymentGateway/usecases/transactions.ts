...
export interface TransactionsUsecase {
  execute: (
    loginId: string
...
export class Transactions implements TransactionsUsecase {
  ...
  async execute(
    ...
    return await this.paymentGatewayRepository.transactions(loginId); // Call the 'createPaymentGateway' method of the PaymentGatewayRepository and return the result
  }
}
