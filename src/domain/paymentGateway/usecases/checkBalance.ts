...
export class CheckBalance implements CheckBalanceUsecase {
  ...
  async execute(
    ...
    return await this.paymentGatewayRepository.checkBalance(loginId); // Call the 'createPaymentGateway' method of the PaymentGatewayRepository and return the result
  }
}
