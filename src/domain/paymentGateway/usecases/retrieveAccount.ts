...
export interface RetrieveAccountUsecase {
  execute: (
    loginId: string
...
export class RetrieveAccount implements RetrieveAccountUsecase {
  ...
  async execute(
    ...
    return await this.paymentGatewayRepository.retrieveAccount(loginId); // Call the 'createPaymentGateway' method of the PaymentGatewayRepository and return the result
  }
}
