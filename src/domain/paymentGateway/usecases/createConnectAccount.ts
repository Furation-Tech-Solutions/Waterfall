...
export interface CreateConnectAccountUsecase {
  execute: (
    loginId: string,
    data: any
...
export class CreateConnectAccount implements CreateConnectAccountUsecase {
  ...
  async execute(
    ...
    return await this.paymentGatewayRepository.createConnectAccount(loginId, data); // Call the 'createPaymentGateway' method of the PaymentGatewayRepository and return the result
  }
}
